...
export function base64_decode(sBase64, nBlocksSize = 0) {
...
export function base64_encode(aBytes, options) {
    let nMod3 = 2;
    let sB64Enc = "";
...
export function base64_encode_string(aBytes) {
    return base64_encode(Uint8Array.from(Array.from(aBytes).map((c) => c.charCodeAt(0))));
}
export function base64_encode2(aBytes) {
